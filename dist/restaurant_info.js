...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
function createReviewHTML(review) {
  ...
  date.innerHTML = moment__WEBPACK_IMPORTED_MODULE_1__(review.createdAt).format('LL');
  li.appendChild(date);
